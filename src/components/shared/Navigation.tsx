    ...
    <>
      ...
      >
        <div
          ...
          className={`absolute inset-0 bg-gray-900/20 backdrop-blur-sm transition-opacity duration-300 dark:bg-black/40 ${
        ...
        <div
          role="dialog"
          aria-modal="true"
          className={`absolute top-0 right-0 h-full w-[80vw] max-w-xs overflow-y-auto bg-white shadow-xl transition-transform duration-300 ease-out dark:bg-gray-950 ${
